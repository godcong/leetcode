...
- [LeetCode](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-using-strategy/)
...
修改 策略 利润计算 利润 原始 \[-1, 0, 1] (-1 × 4) + (0 × 2) + (1 × 8) = -4 + 0 + 8 4 修改 \[0, 1] \[0, 1, 1] (0 × 4) + (1 × 2) + (1 × 8) = 0 + 2 + 8 10 修改 \[1, 2] \[-1, 0, 1] (-1 × 4) + (0 × 2) + (1 × 8) = -4 + 0 + 8 4
