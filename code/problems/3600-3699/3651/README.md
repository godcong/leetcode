...
- [LeetCode](https://leetcode-cn.com/problems/minimum-cost-path-with-teleportations/)
...
当前位置 移动 新位置 总成本 `(0, 0)` 向下移动 `(1, 0)` `0 + 2 = 2` `(1, 0)` 向右移动 `(1, 1)` `2 + 5 = 7` `(1, 1)` 传送到 `(2, 2)` `(2, 2)` `7 + 0 = 7`
...
当前位置 移动 新位置 总成本 `(0, 0)` 向下移动 `(1, 0)` `0 + 2 = 2` `(1, 0)` 向右移动 `(1, 1)` `2 + 3 = 5` `(1, 1)` 向下移动 `(2, 1)` `5 + 4 = 9`
