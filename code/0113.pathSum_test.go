...
func Test_pathSum(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{
			name: "",
			args: args{
				root: leetcode.strToTreeNode("[5,4,8,11,null,13,4,7,2,null,null,5,1]"),
				sum:  22,
			},
			want: [][]int{
				{5, 4, 11, 2},
